...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="w-full sm:w-[95%] md:w-[90%] lg:w-[928px] xl:w-[1250px] 2xl:w-[1500px] px-[10px] m-auto min-h-[600px] flex flex-col lg:flex-row lg:justify-between py-12 gap-8 lg:gap-4"
    >
      {/* Left: Info + Links */}
